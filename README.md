# This tool is used to generate a labels txt file and audio ogg file for [SebiAi's custom glyph lighting scripts](https://github.com/SebiAi/custom-nothing-glyph-tools)
# To use:
